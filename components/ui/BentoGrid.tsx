      ...
      <div className={`${id === 6} && 'flex justify-center h-full'`}>
        ...
        {id === 6 && (
          <BackgroundGradientAnimation>
            <div className="absolute z-60 flex items-center justify-center text-white font-bold" />
          </BackgroundGradientAnimation>
        )}
        ...
        >
          <div className="font-sans text-sm md:text-xs lg:text-base z-10 font-normal text-[#c1c2d3] ">
            {description}
          </div>
